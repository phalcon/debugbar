...
class Debug
{
    ...
    {
        // @phpstan-ignore argument.type (bool return is unused by set_exception_handler)
    ...
    {
        // @phpstan-ignore argument.type (a void return is treated as a non-false return)
